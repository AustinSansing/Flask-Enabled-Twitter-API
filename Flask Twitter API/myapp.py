...
consumer_key = '<paste the key that you created in the twitter developer console>'
consumer_secret = '<paste the secret key that you created in the twitter developer console>'
access_token = '<paste the access token that you created in the twitter developer console>'
access_token_secret = '<paste the access token secret that you created in the twitter developer console>'
...
def send():
	if request.method=='POST':
		...
		print(user_interest)
		usr = api.get_user(screen_name=user_interest)
...
def hash():
	if request.method=='POST':
		...
		h = tweepy.Cursor(api.search_tweets, q = hashtag, count = "10", lang = "en", since = "2018-11-11").items()
